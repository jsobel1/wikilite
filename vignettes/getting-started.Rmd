...
knitr::opts_chunk$set(
  ...
  eval       = on_ci,
  cache      = on_ci,
  cache.path = "cache/getting-started-",
  message    = FALSE,
  warning    = FALSE,
  error      = TRUE
)
...
Fetch snapshots of an article at several historical dates by looping over
`get_article_most_recent_table()` with different `date_an` arguments, then
apply quality metrics to each snapshot.
