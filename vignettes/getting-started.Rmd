---
title: "Getting Started with wikilite"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with wikilite}
...
## 10. Time-series probing (new in v0.1.0)

`probe_article_over_time()` fetches article snapshots at multiple dates
and computes quality metrics at each point — useful for longitudinal analysis.

```{r probing}
dates <- paste0(2018:2024, "-01-01T00:00:00Z")
probe_df <- probe_article_over_time(
  "Zeitgeber",
  dates_to_probe = dates,
  metrics        = c("sci_score", "doi_count", "ref_count")
)
probe_df
```
